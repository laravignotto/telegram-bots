...
FIRST, LAST = range(2)
# Callback data
COMANDI, HOWTO, ABOUT, ESC, RESTART = range(5)
...
class Help:
    ...
    def help(self, update, context):
        ...
        keyboard = [
                    [
                        InlineKeyboardButton("Come si usa", callback_data=str(HOWTO)),
    ...
    def registerToDispatcher(self):
        conv_handler = ConversationHandler(
            ...
            states={
                    FIRST: [CallbackQueryHandler(self.howTo, pattern='^' + str(HOWTO) + '$'),
                            CallbackQueryHandler(self.about, pattern='^' + str(ABOUT) + '$'),
                            CallbackQueryHandler(self.commands, pattern='^' + str(COMANDI) + '$'),
